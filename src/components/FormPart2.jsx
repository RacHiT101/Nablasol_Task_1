// src/components/FormPart2.js
import { useState } from "react";

const FormPart2 = ({ goBack, goNext }) => {
  const [projectType, setProjectType] = useState("Time & Materials");
  const [projectHourlyRate, setProjectHourlyRate] = useState("₹12,678.00");
          ...
          <div className="mb-4">
            ...
            <div className="mb-4">
              <label className="block">
                ...
                <h5 className="text-sm text-slate-600 mb-4">
                  We need hourly rates to track the project's billable amount
                </h5>
                <select
                  required
                ...
                >
                  ...
                  <option>Amount per Person</option>
                </select>
              </label>
            </div>
